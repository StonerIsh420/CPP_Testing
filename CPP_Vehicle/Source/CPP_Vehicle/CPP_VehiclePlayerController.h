 ...
 */
UCLASS(abstract)
class ACPP_VehiclePlayerController : public APlayerController
{
	GENERATED_BODY()
...
protected:
	...
	TSubclassOf<ACPP_VehiclePawn> VehiclePawnClass;

	/** Pointer to the controlled vehicle pawn */
	TObjectPtr<ACPP_VehiclePawn> VehiclePawn;

	/** Type of the UI to spawn */
	UPROPERTY(EditAnywhere, Category="Vehicle|UI")
	TSubclassOf<UCPP_VehicleUI> VehicleUIClass;

	/** Pointer to the UI widget */
	TObjectPtr<UCPP_VehicleUI> VehicleUI;
